...
describe Hysync::MarcSynchronizer::MarcHyacinthRecord do
  let(:marc_record) do
    ...
    record.append(MARC::DataField.new('965', ' ',  ' ', ['a', '965hyacinth'], ['p', 'project_1'], ['p', 'project_2']))
  ...
  let(:expected) do
    [
      ...
      {"other_project_term"=>{"uri" => "info:hyacinth.library.columbia.edu/projects/carnegie_dpf"}},
